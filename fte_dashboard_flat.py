...
# --- File paths (no subfolders) ---
optimal_path = "optimal_fte.xlsx"
forecast_path = "fte_forecast.xlsx"
bri_data_path = "FTE_analysis_AG.xlsx"
...
if page == "📊 Overview":
    ...
    if actual_df.empty:
        st.warning("Upload 'FTE_analysis_AG.xlsx' to the main app folder.")
    else:
